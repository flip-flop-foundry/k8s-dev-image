...
#
# Usage: install-tools.sh <path-to-env-file>
#

set -euo pipefail

# --- Require env file argument ---
if [[ $# -lt 1 ]]; then
  echo "❌ Error: env file path is required." >&2
...
# KubeVirt plugin for k9s (symlinked from .devcontainer/kubevirt.yaml)
